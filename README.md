...
- De préférence, ouvrir l'application dans un IDE professionnel. L'adresse pour la lancer est : http://localhost/mediatekformation-master/ 
et pointer l'index file dans public/index.php<br>
